...
I have built a Rust based terminal user interface - using the [**ratatui**](https://ratatui.rs/) framework - called [**Mountains**](https://github.com/papadavis47/mountains) - designed for logging trail running daily training.
