        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="h-auto max-w-5xl transform rounded-xl bg-white p-6 px-10 text-center align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="mt-6 scroll-auto">
                    <p className="text-left text-sm italic text-gray-900 sm:text-justify md:px-10 md:text-lg">
                      ...
                      happens often, until the most challenging parts of a run
                      have passed or until the problem in the code is solved. As
                      a dev in a rapidly changing profession, I find that the
                      best way to handle the discomfort is to simply get
                      comfortable with the feeling and live there.
                    </p>
                  </div>
