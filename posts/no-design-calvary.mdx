...
## CSS and Design <Emoji emoji="🆘" label="SOS button" />
...
## Starving Solo Artistry <Emoji emoji="🥫" label="canned food" /> <Emoji emoji="🎨" label="artist palette" />
...
## No Designers Around <Emoji emoji="😭" label="loudly crying face" />
...
## On my own? <Emoji emoji="😨" label="fearful face" />
